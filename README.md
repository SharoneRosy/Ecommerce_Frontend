...
1. Clone Frontend repository: `git clone https://github.com/SharoneRosy/Ecommerce_frontend.git`
2. Clone Backend Repository: `git clone https://github.com/SharoneRosy/Ecommerce_backend.git`
3. Change directory Frontend:`cd Ecommerce_frontend`
4. Change directory Backend: `cd Ecommerce_backend`
